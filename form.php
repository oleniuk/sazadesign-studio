...
<html lang="ru">
    ...
    <meta name="viewport" content="width=device-width">
        <title>Thank you! Your submission has been received!</title>
...
<!-- End Meta Pixel Code -->
    ...
    <div class="wrapper">
        <div class="block_success">          
            <h2 style="text-transform: uppercase;">Thank you! Your submission has been received!</h2>
            <p class="success">
            ...
            <div class="success">
                <ul class="list_info">
                    <li><span>Your name:  </span><span id="client"><?=$_GET['name']?></span></li>
                    <li><span>Your phone: </span><span id="tel"><?=$_GET['phone']?></span></li>
                </ul>
                <br/><span id="submit"></span>
            </div>
            <p class="fail success">If you made a mistake while filling out the form, then please <a href="javascript: history.back(-1);">fill out the application again</a></p>      
